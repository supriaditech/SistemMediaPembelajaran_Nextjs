...
import ModalAddMateri from "@/components/beranda/guru/Modal/ModalAddMateri";
...
function Profile() {
  ...
  return (
    <Master title={"Profile Page"}>
      <div className="md:flex flex-col p-4 md:p-20 mx-auto gap-8 justify-center items-center md:items-start  min-h-screen">
        <div className="md:flex md:px-10 lg:px-40 py-20 mx-auto gap-8 justify-center items-center md:items-center bg-blue-100 rounded-lg">
          {photoProfile ? (
        ...
        <div className=" md:px-10 lg:px-40 py-4 mx-auto gap-8 ">
